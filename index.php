                ...
                <div class="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
                    <div class="grid lg:grid-cols-12 gap-8 lg:gap-12 items-center">
                        ...
                        <div class="lg:col-span-7 grid sm:grid-cols-2 gap-4">
                            <a href="<?= BASE_URL ?>/abiturientam/pravila-priema" class="group flex flex-col p-7 rounded-[28px] bg-white border-2 border-sage-600 shadow-soft hover:shadow-card transition-all duration-300">
