...
if (empty($apiKey)) {
    ...
    $reply = 'По вашему вопросу рекомендую обратиться в приёмную комиссию или изучить разделы сайта: «Абитуриентам», «О колледже», объявления. Контакты указаны в шапке и подвале сайта.';
