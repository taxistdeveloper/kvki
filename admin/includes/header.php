...
$navGroups = [
    ...
    'Контент' => [
        ...
        ['action' => 'videos', 'label' => 'Видео', 'icon' => 'M15 10l4.553-2.276A1 1 0 0121 8.618v6.764a1 1 0 01-1.447.894L15 14M5 18h8a2 2 0 002-2V8a2 2 0 00-2-2H5a2 2 0 00-2 2v8a2 2 0 002 2z'],
        ['action' => 'anticor', 'label' => 'Антикор', 'icon' => 'M9 12h6m-6 4h6m2 5H7a2 2 0 01-2-2V5a2 2 0 012-2h5.586a1 1 0 01.707.293l5.414 5.414a1 1 0 01.293.707V19a2 2 0 01-2 2z'],
            ...
            theme: {
                extend: {
                    ...
                    colors: {
                        ...
                        sage: { 50: '#f2f5f7', 100: '#e6edf1', 200: '#c6d6de', 300: '#93afbe', 400: '#5f8396', 500: '#3b6275', 600: '#253f50', 700: '#1f3543', 800: '#1a2c38', 900: '#15232d' },
                        ink: { 400: '#94a3b8', 500: '#64748b', 600: '#475569', 700: '#334155', 800: '#1e293b', 900: '#0f172a' }
                    },
                    boxShadow: {
                        'soft': '0 1px 2px 0 rgb(15 23 42 / 0.04), 0 8px 20px 0 rgb(15 23 42 / 0.06)',
                        'card': '0 2px 6px 0 rgb(15 23 42 / 0.06), 0 12px 28px 0 rgb(15 23 42 / 0.09)',
